...
<template>
  ...
  >
    ...
    <!-- Submit Button - 修改了颜色样式 -->
    <button
      :disabled="!vanishingText"
      type="submit"
      class="absolute top-1/2 right-2 z-50 flex size-8 -translate-y-1/2 items-center justify-center rounded-full transition duration-200 disabled:bg-rose-100 enabled:bg-rose-500 hover:enabled:bg-rose-600 dark:disabled:bg-rose-950/30 dark:enabled:bg-rose-600 dark:hover:enabled:bg-rose-700"
    >
      <svg
        ...
        :class="cn('size-4', vanishingText ? 'text-white' : 'text-rose-200 dark:text-rose-300/50')"
      >
        <path
          stroke="none"
          d="M0 0h24v24H0z"
